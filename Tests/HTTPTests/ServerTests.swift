...
class ServerTests: XCTestCase {
    func testResponseOK() {
        let request = HTTPRequest(method: .get, target: "/echo", httpVersion: HTTPVersion.v1_1, headers: ["X-foo": "bar"])
    ...
    func testEcho() {
        ...
        let request = HTTPRequest(method: .post, target: "/echo", httpVersion: HTTPVersion.v1_1, headers: ["X-foo": "bar"])
    ...
    func testHello() {
        let request = HTTPRequest(method: .get, target: "/helloworld", httpVersion: HTTPVersion.v1_1, headers: ["X-foo": "bar"])
        let resolver = TestResponseResolver(request: request, requestBody: Data())
